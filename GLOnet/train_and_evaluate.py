...
def evaluate(generator, eng, numImgs, params, thickness):
    generator.eval()
    ...
    effs = compute_effs(images, eng, params, thickness)
...
def train(generator, optimizer, scheduler, eng, params, thickness, pca=None):
    ...
    with tqdm(total=params.numIter) as t:
        ...
        while True:
            ...
            effs, gradients = compute_effs_and_gradients(gen_imgs, eng, params, thickness)
            ...
            if it % params.plot_iter == 0:
                ...
                effs_mean, binarization, diversity = evaluate_training_generator(generator, eng, params, thickness)
...
def compute_effs_and_gradients(gen_imgs, eng, params,thickness):
    '''
    Args:
        imgs: N x C x H
    ...
    thick_ness = matlab.double(thickness)

    # call matlab function to compute efficiencies and gradients

    effs_and_gradients = eng.GradientFromSolver_1D_parallel(img, wavelength, desired_angle, thick_ness, params.matname)  
...
def compute_effs(imgs, eng, params, thickness):
    '''
    Args:
        imgs: N x C x H
        eng: matlab engine
    ...
    effs = eng.Eval_Eff_1D_parallel(img, wavelength, desired_angle, thick_ness, params.matname)
...
def evaluate_training_generator(generator, eng, params, thickness, num_imgs = 100):
    ...
    effs = compute_effs(imgs, eng, params, thickness)
