...
# RCWA path
eng.addpath(eng.genpath('/Desktop/pho_code_packages/MN_GLOnet/reticolo_allege_v9'));
...
parser.add_argument('--thickness', type=int, default=325,
                                        help="Optional, input thickness for metagratings")
parser.add_argument('--matname', default='p_Si.mat',
                                        help="Optional, name of the .mat file contains property for material")                                        
...
if __name__ == '__main__':
    ...
    if params.numIter != 0 :
        ...
        train(generator, optimizer, scheduler, eng, params, thickness=args.thickness)

    # Generate images and save 
    logging.info('Start generating devices')
    evaluate(generator, eng, numImgs=500, params=params, thickness=args.thickness)
