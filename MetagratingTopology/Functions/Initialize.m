...
OptParm.Input.Wavelength = 400; % Wavelength of incident light
OptParm.Input.Polarization = 'TE'; % Polarization: can be 'TM', 'TE' or 'Both'
...
OptParm.Geometry.Substrate = 1.45; % Refractive index of substrate silica
OptParm.Geometry.Device = 2.00623473609108+1i*0.0162199352172530; % Refractive index of device
...
OptParm.Optimization.RandomStart.Pitch = 10; % Grid size on which to create random Gaussians
